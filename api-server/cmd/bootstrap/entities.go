...
// project / skill_apply / ai_provider / market_source / market_skill /
...
// 2026-07-17 改造:skill_file / skill_tag / skill_file_snapshot 表下线,
// 版本管理改走 ~/.skill-box/skills/ 的 git 仓库(go-git,见 internal/skillversion)。
var EntityAutoMigrateList = []any{
	new(entity.User),

	new(entity.Project),
	// 2026-07-17 改造:skill_tags / skill_file_snapshots / skill_files 表下线,

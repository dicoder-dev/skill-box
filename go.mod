...
require (
	ginp-api v0.0.0-00010101000000-000000000000
	github.com/wailsapp/wails/v3 v3.0.0-alpha.60
	golang.org/x/image v0.24.0
)

replace ginp-api => ./api-server
...
require (
	...
	github.com/go-kratos/blades v0.5.0 // indirect
	github.com/go-kratos/blades/contrib/anthropic v0.3.0 // indirect
	github.com/go-kratos/blades/contrib/openai v0.3.0 // indirect

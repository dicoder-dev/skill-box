...
export default {
  ...
  skills: {
    ...
    list: {
      ...
      applyOverwriteTitle: 'Overwrite existing skill',
      applyOverwriteMessage: 'A skill with the same name already exists there. Continuing will overwrite the original files (irreversible). Continue?',
      applySuccess: 'Enabled: {path}',
      applyFailed: 'Failed to enable: {msg}',
      unapplyConfirmTitle: 'Disable location',
      unapplyConfirmMessage: 'Delete skill "{name}" from {tool} · {scope} (physical rm -rf). This is irreversible. Continue?',
